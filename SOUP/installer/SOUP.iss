...
; Misc Settings
; ============================================================================
SetupMutex=SOUP_Setup_Mutex_{#MyAppVersion}
AppMutex=SOUP_App_Mutex
...
WelcomeLabel2=This will install {#MyAppFullName} v{#MyAppVersion} on your computer.%n%nS.O.U.P. is a suite of tools designed to enhance your S.A.M. workflow.%n%nIt is recommended that you close all other applications before continuing.
...
Name: "core"; Description: "S.O.U.P Core (required)"; Types: full compact custom; Flags: fixed
; Main modules
...
Name: "funstuff\nukem"; Description: "S.O.U.P NUKEM - Hidden retro FPS Easter egg"; Types: full custom
...
Source: "..\publish-framework\SOUP.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: not IsPortableInstall
Source: "..\publish-framework\SOUP.dll"; DestDir: "{app}"; Flags: ignoreversion; Check: not IsPortableInstall
Source: "..\publish-framework\SOUP.pdb"; DestDir: "{app}"; Flags: ignoreversion; Check: not IsPortableInstall
Source: "..\publish-framework\SOUP.xml"; DestDir: "{app}"; Flags: ignoreversion; Check: not IsPortableInstall
Source: "..\publish-framework\SOUP.deps.json"; DestDir: "{app}"; Flags: ignoreversion; Check: not IsPortableInstall
Source: "..\publish-framework\SOUP.runtimeconfig.json"; DestDir: "{app}"; Flags: ignoreversion; Check: not IsPortableInstall
...
Source: "..\publish-portable\SOUP.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: IsPortableInstall
...
begin
  ...
  if WizardIsComponentSelected('funstuff\nukem') then
    ConfigContent := ConfigContent + '    "soupNukem": true' + #13#10
  else
    ConfigContent := ConfigContent + '    "soupNukem": false' + #13#10;
...
begin
  ...
  ModulesLabel.Caption := 
    ...
    '  * S.O.U.P NUKEM - Hidden retro FPS Easter egg';
