<#
.SYNOPSIS
    Builds and runs the AllocationBuddy standalone application.

.DESCRIPTION
    This script builds and launches the AllocationBuddy standalone application
...
Write-Host "  ║         AllocationBuddy Launcher          ║" -ForegroundColor Cyan
Write-Host "  ╚═══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "Starting AllocationBuddy..." -ForegroundColor Cyan
Write-Host ""

$exePath = "SAP\src\AllocationBuddy.Standalone\bin\$configuration\net8.0-windows\AllocationBuddy.exe"
