<#
.SYNOPSIS
    Builds and runs the ExpireWise standalone application.

.DESCRIPTION
    This script builds and launches the ExpireWise standalone application
...
$project = "SAP\src\ExpireWise.Standalone\ExpireWise.Standalone.csproj"
...
Write-Host "  ║           ExpireWise Launcher             ║" -ForegroundColor Cyan
Write-Host "  ╚═══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "Starting ExpireWise..." -ForegroundColor Cyan
Write-Host ""

$exePath = "SAP\src\ExpireWise.Standalone\bin\$configuration\net8.0-windows\ExpireWise.exe"
